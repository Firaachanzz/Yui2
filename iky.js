...
`
                    ...
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'POWERED BY IKKY', buttons: [{ buttonId: `!command`, buttonText: { displayText: 'SIMPLE SELECT MENU' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: IkyAds, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
